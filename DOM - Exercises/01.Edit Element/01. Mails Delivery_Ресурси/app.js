function solve() {
    ...
    addButtonElement.addEventListener('click', (e) => {
        ...
        e.preventDefault();
        if ((userNameInputElement.value.length > 0 && userNameInputElement.value != (result = patternForSpaces.exec(userNameInputElement.value))) && (titleInputElement.value.length > 0 && titleInputElement.value != (result = patternForSpaces.exec(titleInputElement.value))) && (messageInputElement.value.length > 0 && messageInputElement.value != (result = patternForSpaces.exec(messageInputElement.value)))) {
